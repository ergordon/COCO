...
def ComparePlotsFunc (path, pathA, pathB):
    ...
    fig.savefig(os.path.join(newPath, "ChannelLocationwLuminoisty.jpeg") , orientation='landscape', quality=95)
    fig1.savefig(os.path.join(newPath, "LuminosityOverallDistribution.jpeg") , orientation='landscape', quality=95)
    fig2.savefig(os.path.join(newPath, "ChannelDensity.jpeg") , orientation='landscape', quality=95)
    fig3.savefig(os.path.join(newPath, "LuminosityHeatMap.jpeg") , orientation='landscape', quality=95)
    fig4.savefig(os.path.join(newPath, "AreaHistorgram.jpeg") , orientation='landscape', quality=95)
    fig5.savefig(os.path.join(newPath, "HeighttoWidthHistogram.jpeg") , orientation='landscape', quality=95)
    fig6.savefig(os.path.join(newPath, "AreaHeatmap.jpeg") , orientation='landscape', quality=95)
    fig7.savefig(os.path.join(newPath, "HeighttoWidthHeatmap.jpeg") , orientation='landscape', quality=95)
    fig8.savefig(os.path.join(newPath, "ChannelLocation.jpeg") , orientation='landscape', quality=95)
